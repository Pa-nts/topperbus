...
export const CAMPUS_BUILDINGS: CampusBuilding[] = [
  ...
  },
  {
    ...
    description: 'Houses the College of Education and Behavioral Sciences. Named after Dr. Tate C. Page, former dean of the College of Education.',
  },
  {
    id: 'fac',
  ...
  },
  {
    ...
    lon: -86.45772,
    categories: ['academic'],
    department: 'School of Journalism & Broadcasting',
    description: 'Home to the School of Journalism & Broadcasting. Features professional broadcast studios, newsrooms, and production facilities.',
  },
  {
    id: 'snell',
    name: 'Snell Hall',
  ...
  },
  {
    ...
    categories: ['academic'],
    department: 'Ogden College of Science & Engineering',
    description: 'Modern facility supporting STEM education. Features advanced laboratories, collaborative learning spaces, and technology-enhanced classrooms.',
  },
  {
    id: 'grh',
  ...
  // === LIBRARY ===
  {
    ...
    description: 'WKU\'s main library offering extensive collections, study spaces, and research support. Combines Helm Library (1931) and Cravens Library (1969).',
  },
  ...
  },
  {
    ...
    description: 'All-you-care-to-eat dining hall featuring multiple food stations with fresh, made-to-order options including international cuisine.',
  },
  ...
  {
    id: 'bemis',
    name: 'Bemis Lawrence Hall',
    abbreviation: 'BLH',
    lat: 36.98920,
    lon: -86.45595,
    categories: ['residential'],
    department: 'Housing & Residence Life',
    description: 'One of the original residence halls on campus. Offers a traditional college living experience with modern amenities.',
  },
  {
    id: 'mclean',
    name: 'McLean Hall',
